...
public:
    ...
    void drawStrokeDottedLine(
        ...
        float spacing = 2.0f, 
        float stroke = 2.0f, 
        const Color4& strokeColor = Color4(0.0f, 0.0f, 0.0f)
    );
    void drawRect(
        const UILayout& layout, 
        const UIBounds& bounds, 
    ...
    void drawStrokeRect(
        ...
        int stroke = 1, 
        const Color4& strokeColor = Color4(0.0f, 0.0f, 0.0f), 
        const UIStrokeAlignment& strokeAlignment = UIStrokeAlignment::Outside
    );
    ...
    void drawArrow(
        ...
        float rotation = 0, 
        const Color4& color = Color4(), 
        float stumpLength = 20, 
        float armLength = 14, 
        float lineThickness = 3
    );
    void drawStrokeArrow(
        const UIDim2& position, 
        const UIBounds& bounds, 
        float rotation = 0, 
        const Color4& color = Color4(), 
    ...
    void drawSolidArrow(
        ...
        float rotation = 0, 
        const Color4& color = Color4(), 
        const Vector2& stumpSize = Vector2(10, 10), 
        const Vector2& headSize = Vector2(20, 10)
    );
    void drawSolidStrokeArrow(const UIDim2& position, 
        const UIBounds& bounds, 
        float rotation = 0, 
        const Color4& color = Color4(), 
        const Vector2& stumpSize = Vector2(10, 10), 
