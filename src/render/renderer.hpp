...
public:
    ...
    void drawStrokeDottedLine(const UIDim2& position1, const UIDim2& position2, const UIBounds& bounds, const Color4& color = Color4(), float thickness = 1.0f, float dotLength = 2.0f, float spacing = 2.0f, float stroke = 2.0f, const Color4& strokeColor = Color4(0.0f, 0.0f, 0.0f));
    ...
    void drawArrow(const UIDim2& position, const UIBounds& bounds, float rotation = 0, const Color4& color = Color4(), float stumpLength = 20, float armLength = 14, float lineThickness = 3);
